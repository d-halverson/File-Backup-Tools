...
class FileTreeTest {
	...
	protected final FileNode zebra = new FileNode("/Users/drewhalverson/OneDrive - "
			+ "UW-Madison/Github/File_Backup_Tools/files_for_testing/zebra.rtf", null);
	protected final FileNode doggy = new FileNode("/Users/drewhalverson/OneDrive - "
			+ "UW-Madison/Github/File_Backup_Tools/files_for_testing/doggy.pdf", null);
	protected final FileNode Doggy = new FileNode("/Users/drewhalverson/OneDrive - "
			+ "UW-Madison/Github/File_Backup_Tools/files_for_testing/Doggy.pdf", null);
	...
	/**
	 * Checks to see the results of several calls to the contains() method to see if they are correct.
	 */
	@Test
